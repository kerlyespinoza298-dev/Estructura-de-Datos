...
/**
 * TDA principal que define las operaciones validas de la cadena.
 *
 * Los atributos privados de Persona y Objeto no se modifican directamente
 * desde Main. Toda transicion de estado se realiza mediante estas operaciones.
 */
public class CadenaTransmision {

    /**
     * Precondicion: la persona y el objeto deben existir.
     * Postcondicion: si la persona esta infectada, el objeto queda contaminado.
     */
    ...
    /**
     * Precondicion: la persona y el objeto deben existir.
     * Postcondicion: si el objeto esta contaminado, las manos quedan contaminadas.
     */
    ...
    /**
     * Precondicion: las dos personas deben existir y ser diferentes.
     * Postcondicion: si el origen tiene las manos contaminadas, el destino
     * queda con las manos contaminadas.
     */
    ...
    /**
     * Precondicion: la persona debe existir.
     * Postcondicion: si tiene las manos contaminadas, queda infectada.
     */
    ...
    /**
     * Postcondicion: la persona queda con las manos limpias.
     * El lavado no cambia el estado de una persona que ya estaba infectada.
     */
    ...
    /** Postcondicion: el objeto queda limpio. */
