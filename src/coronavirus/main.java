 ...
 *
 * El programa modela la secuencia de contacto mostrada en la imagen:
 * persona infectada -> objeto contaminado -> manos contaminadas ->
 * contacto con otra persona -> toque del rostro -> nueva infeccion.
 */
public class main {
    ...
    /** Caso 1: la cadena llega hasta una nueva infeccion. */
    ...
    /** Caso 2: el lavado de manos interrumpe la cadena. */
